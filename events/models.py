...
class Event(models.Model):
    ...
    public_modi = models.BooleanField(_('Modi'), default=True, help_text=_("A boolean field that sets who can modify the event. Possible values: true meaning anyone can modify it, false meaning only the owner can modify it."))
    #
