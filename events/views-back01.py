...
###############################################################################
                ...
                if len(tpart_list)>2:
                    return render_to_response('error.html',
                        {'title': 'error', 'message_col1': _("You have submitted an invalid search - one of your time ranges contain more then 2 elements") + ".", 'query': q},
                        context_instance=RequestContext(request))
                ...
                if re.search('^\d+-', tpart_from_diff) is not None:
                    return render_to_response('error.html',
                        {'title': 'error', 'message_col1': _("You have submitted an invalid search - you are trying to add or subtract more than one value from a 'from' date") + ".", 'query': q},
                        context_instance=RequestContext(request))
                try:
                ...
                if re.search('^\d+-', tpart_to_diff) is not None:
                    return render_to_response('error.html',
                        {'title': 'error', 'message_col1': _("You have submitted an invalid search - you are trying to add or subtract more than one value from a 'to' date") + ".", 'query': q},
                        context_instance=RequestContext(request))
                try:
                ...
                try:
                    ...
                    return render_to_response('error.html',
                        {'title': 'error', 'message_col1': _("You have submitted an invalid search - one of your dates is in invalid format or is not a date at all") + ".", 'query': q},
                        context_instance=RequestContext(request))
...
###############################################################################
                    ...
                    return render_to_response('error.html',
                        {'title': 'error', 'message_col1': _("You have submitted an invalid search - check your query format and try again") + ".", 'query': q},
                        context_instance=RequestContext(request))
