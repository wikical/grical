...
TIMEZONES = (
    ( _( 'Africa' ), ( # {{{2
        ...
        ( 'Africa/Addis_Ababa', unicode(_( 'Africa' )) + u'/' + unicode(_( 'Addis Ababa' )) ),
        ...
        ( 'Africa/Dar_es_Salaam', unicode(_( 'Africa' )) + u'/' + unicode(_( 'Dar es Salaam' )) ),
        ( 'Africa/Djibouti', unicode(_( 'Africa' )) + u'/' + unicode(_( 'Djibouti' )) ),
        ( 'Africa/Douala', unicode(_( 'Africa' )) + u'/' + unicode(_( 'Douala' )) ),
        ( 'Africa/El_Aaiun', unicode(_( 'Africa' )) + u'/' + unicode(_( 'El Aaiun' )) ),
        ...
        ( 'Africa/Juba', unicode(_( 'Africa' )) + u'/' + unicode(_( 'Juba' )) ),
        ...
        ( 'Africa/Sao_Tome', unicode(_( 'Africa' )) + u'/' + unicode(_( 'Sao Tome' )) ),
    ...
    ( _( 'America' ), ( # {{{2
        ...
        ( 'America/Argentina/Buenos_Aires', unicode(_( 'America' )) + u'/' + unicode(_( 'Argentina' )) + u'/' + unicode(_( 'Buenos Aires' )) ),
        ...
        ( 'America/Argentina/La_Rioja', unicode(_( 'America' )) + u'/' + unicode(_( 'Argentina')) + u'/' + unicode(_( 'La Rioja' )) ),
        ( 'America/Argentina/Mendoza', unicode(_( 'America' )) + u'/' + unicode(_( 'Argentina')) + u'/' + unicode(_( 'Mendoza' )) ),
        ( 'America/Argentina/Rio_Gallegos', unicode(_( 'America' )) + u'/' + unicode(_( 'Argentina')) + u'/' + unicode(_( 'Rio Gallegos' )) ),
        ( 'America/Argentina/Salta', unicode(_( 'America' )) + u'/' + unicode(_( 'Argentina')) + u'/' + unicode(_( 'Salta' )) ),
        ( 'America/Argentina/San_Juan', unicode(_( 'America' )) + u'/' + unicode(_( 'Argentina')) + u'/' + unicode(_( 'San Juan' )) ),
        ( 'America/Argentina/San_Luis', unicode(_( 'America' )) + u'/' + unicode(_( 'Argentina')) + u'/' + unicode(_( 'San Luis' )) ),
        ...
        ( 'America/Bahia_Banderas', unicode(_( 'America' )) + u'/' + unicode(_( 'Bahia_Banderas' )) ),
        ...
        ( 'America/Boa_Vista', unicode(_( 'America' )) + u'/' + unicode(_( 'Boa Vista' )) ),
        ( 'America/Bogota', unicode(_( 'America' )) + u'/' + unicode(_( 'Bogota' )) ),
        ( 'America/Boise', unicode(_( 'America' )) + u'/' + unicode(_( 'Boise' )) ),
        ( 'America/Cambridge_Bay', unicode(_( 'America' )) + u'/' + unicode(_( 'Cambridge Bay' )) ),
        ( 'America/Campo_Grande', unicode(_( 'America' )) + u'/' + unicode(_( 'Campo Grande' )) ),
        ...
        ( 'America/Costa_Rica', unicode(_( 'America' )) + u'/' + unicode(_( 'Costa Rica' )) ),
        ( 'America/Creston', unicode(_( 'America' )) + u'/' + unicode(_( 'Creston' )) ),
        ...
        ( 'America/Dawson_Creek', unicode(_( 'America' )) + u'/' + unicode(_( 'Dawson Creek' )) ),
        ...
        ( 'America/El_Salvador', unicode(_( 'America' )) + u'/' + unicode(_( 'El Salvador' )) ),
        ( 'America/Fortaleza', unicode(_( 'America' )) + u'/' + unicode(_( 'Fortaleza' )) ),
        ( 'America/Fort_Nelson', unicode(_( 'America' )) + u'/' + unicode(_( 'Fort_Nelson' )) ),
        ( 'America/Glace_Bay', unicode(_( 'America' )) + u'/' + unicode(_( 'Glace Bay' )) ),
        ( 'America/Godthab', unicode(_( 'America' )) + u'/' + unicode(_( 'Godthab' )) ),
        ( 'America/Goose_Bay', unicode(_( 'America' )) + u'/' + unicode(_( 'Goose Bay' )) ),
        ( 'America/Grand_Turk', unicode(_( 'America' )) + u'/' + unicode(_( 'Grand Turk' )) ),
        ...
        ( 'America/Indiana/Tell_City', unicode(_( 'America')) + u'/' + unicode(_( 'Indiana' )) + u'/' + unicode(_( 'Tell City' )) ),
        ...
        ( 'America/Kralendijk', unicode(_( 'America' )) + u'/' + unicode(_( 'Kralendijk' )) ),
        ( 'America/La_Paz', unicode(_( 'America' )) + u'/' + unicode(_( 'La Paz' )) ),
        ( 'America/Lima', unicode(_( 'America' )) + u'/' + unicode(_( 'Lima' )) ),
        ( 'America/Los_Angeles', unicode(_( 'America' )) + u'/' + unicode(_( 'Los Angeles' )) ),
        ( 'America/Lower_Princes', unicode(_( 'America' )) + u'/' + unicode(_( 'Lower_Princes' )) ),
        ...
        ( 'America/Marigot', unicode(_( 'America' )) + u'/' + unicode(_( 'Marigot' )) ),
        ...
        ( 'America/Metlakatla', unicode(_( 'America' )) + u'/' + unicode(_( 'Metlakatla' )) ),
        ( 'America/Mexico_City', unicode(_( 'America' )) + u'/' + unicode(_( 'Mexico City' )) ),
        ...
        ( 'America/New_York', unicode(_( 'America' )) + u'/' + unicode(_( 'New York' )) ),
        ...
        ( 'America/North_Dakota/Beulah', unicode(_( 'America' )) + u'/' + unicode(_( 'North_Dakota/Beulah' )) ),
        ( 'America/North_Dakota/Center', unicode(_( 'America' )) + u'/' + unicode(_( 'North Dakota' )) + u'/' + unicode(_( 'Center' )) ),
        ( 'America/North_Dakota/New_Salem', unicode(_( 'America' )) + u'/' + unicode(_( 'North Dakota' )) + u'/' + unicode(_( 'New Salem' )) ),
        ...
        ( 'America/Rio_Branco', unicode(_( 'America' )) + u'/' + unicode(_( 'Rio Branco' )) ),
        ( 'America/Santarem', unicode(_( 'America' )) + u'/' + unicode(_( 'Santarem' )) ),
        ( 'America/Santiago', unicode(_( 'America' )) + u'/' + unicode(_( 'Santiago' )) ),
        ( 'America/Santo_Domingo', unicode(_( 'America' )) + u'/' + unicode(_( 'Santo Domingo' )) ),
        ( 'America/Sao_Paulo', unicode(_( 'America' )) + u'/' + unicode(_( 'Sao Paulo' )) ),
        ( 'America/Scoresbysund', unicode(_( 'America' )) + u'/' + unicode(_( 'Scoresbysund' )) ),
        ( 'America/Sitka', unicode(_( 'America' )) + u'/' + unicode(_( 'Sitka' )) ),
        ( 'America/St_Barthelemy', unicode(_( 'America' )) + u'/' + unicode(_( 'St_Barthelemy' )) ),
        ( 'America/St_Johns', unicode(_( 'America' )) + u'/' + unicode(_( 'St Johns' )) ),
        ( 'America/St_Kitts', unicode(_( 'America' )) + u'/' + unicode(_( 'St Kitts' )) ),
        ( 'America/St_Lucia', unicode(_( 'America' )) + u'/' + unicode(_( 'St Lucia' )) ),
        ( 'America/St_Thomas', unicode(_( 'America' )) + u'/' + unicode(_( 'St Thomas' )) ),
        ( 'America/St_Vincent', unicode(_( 'America' )) + u'/' + unicode(_( 'St Vincent' )) ),
        ( 'America/Swift_Current', unicode(_( 'America' )) + u'/' + unicode(_( 'Swift Current' )) ),
        ( 'America/Tegucigalpa', unicode(_( 'America' )) + u'/' + unicode(_( 'Tegucigalpa' )) ),
        ( 'America/Thule', unicode(_( 'America' )) + u'/' + unicode(_( 'Thule' )) ),
        ( 'America/Thunder_Bay', unicode(_( 'America' )) + u'/' + unicode(_( 'Thunder Bay' )) ),
    ...
    ( _( 'Antarctica' ), ( # {{{2
        ...
        ( 'Antarctica/Macquarie', unicode(_( 'Antarctica' )) + u'/' + unicode(_( 'Macquarie' )) ),
        ...
        ( 'Antarctica/Troll', unicode(_( 'Antarctica' )) + u'/' + unicode(_( 'Troll' )) ),
        ( 'Antarctica/Vostok', unicode(_( 'Antarctica' )) + u'/' + unicode(_( 'Vostok' )) ), )
    ),
    ( _( 'Arctic' ), ( # {{{2
        ( 'Arctic/Longyearbyen', unicode(_( 'Arctic' )) + u'/' + unicode(_( 'Longyearbyen' )) ), )
    ),
    ( _( 'Asia' ), ( # {{{2
        ...
        ( 'Asia/Barnaul', unicode(_( 'Asia' )) + u'/' + unicode(_( 'Barnaul' )) ),
        ...
        ( 'Asia/Chita', unicode(_( 'Asia' )) + u'/' + unicode(_( 'Chita' )) ),
        ...
        ( 'Asia/Khandyga', unicode(_( 'Asia' )) + u'/' + unicode(_( 'Khandyga' )) ),
        ...
        ( 'Asia/Kuala_Lumpur', unicode(_( 'Asia' )) + u'/' + unicode(_( 'Kuala Lumpur' )) ),
        ...
        ( 'Asia/Phnom_Penh', unicode(_( 'Asia' )) + u'/' + unicode(_( 'Phnom Penh' )) ),
        ...
        ( 'Asia/Srednekolymsk', unicode(_( 'Asia' )) + u'/' + unicode(_( 'Srednekolymsk' )) ),
    ...
    ( _( 'Atlantic' ), ( # {{{2
        ...
        ( 'Atlantic/Cape_Verde', unicode(_( 'Atlantic' )) + u'/' + unicode(_( 'Cape Verde' )) ),
        ...
        ( 'Atlantic/South_Georgia', unicode(_( 'Atlantic' )) + u'/' + unicode(_( 'South Georgia' )) ),
        ( 'Atlantic/St_Helena', unicode(_( 'Atlantic' )) + u'/' + unicode(_( 'St Helena' )) ),
    ...
    ( _( 'Australia' ), ( # {{{2
        ...
        ( 'Australia/Broken_Hill', unicode(_( 'Australia' )) + u'/' + unicode(_( 'Broken Hill' )) ),
        ...
        ( 'Australia/Lord_Howe', unicode(_( 'Australia' )) + u'/' + unicode(_( 'Lord Howe' )) ),
    ...
    ( _( 'Europe' ), ( # {{{2
        ...
        ( 'Europe/Astrakhan', unicode(_( 'Europe' )) + u'/' + unicode(_( 'Astrakhan' )) ),
        ( 'Europe/Athens', unicode(_( 'Europe' )) + u'/' + unicode(_( 'Athens' )) ),
        ( 'Europe/Bratislava', unicode(_( 'Europe' )) + u'/' + unicode(_( 'Bratislava' )) ),
        ...
        ( 'Europe/Busingen', unicode(_( 'Europe' )) + u'/' + unicode(_( 'Busingen' )) ),
        ...
        ( 'Europe/Podgorica', unicode(_( 'Europe' )) + u'/' + unicode(_( 'Podgorica' )) ),
        ...
        ( 'Europe/Ulyanovsk', unicode(_( 'Europe' )) + u'/' + unicode(_( 'Ulyanovsk' )) ),
        ( 'Europe/Uzhgorod', unicode(_( 'Europe' )) + u'/' + unicode(_( 'Uzhgorod' )) ),
        ( 'Europe/Vaduz', unicode(_( 'Europe' )) + u'/' + unicode(_( 'Vaduz' )) ),
        ( 'Europe/Vatican', unicode(_( 'Europe' )) + u'/' + unicode(_( 'Vatican' )) ),
        ...
        ( 'Europe/Zagreb', unicode(_( 'Europe' )) + u'/' + unicode(_( 'Zagreb' )) ),
    ...
    ( _( 'Pacific' ), ( # {{{2
        ...
        ( 'Pacific/Bougainville', unicode(_( 'Pacific' )) + u'/' + unicode(_( 'Bougainville' )) ),
        ( 'Pacific/Chatham', unicode(_( 'Pacific' )) + u'/' + unicode(_( 'Chatham' )) ),
        ( 'Pacific/Chuuk', unicode(_( 'Pacific' )) + u'/' + unicode(_( 'Chuuk' )) ),
        ...
        ( 'Pacific/Pago_Pago', unicode(_( 'Pacific' )) + u'/' + unicode(_( 'Pago Pago' )) ),
        ( 'Pacific/Palau', unicode(_( 'Pacific' )) + u'/' + unicode(_( 'Palau' )) ),
        ( 'Pacific/Pitcairn', unicode(_( 'Pacific' )) + u'/' + unicode(_( 'Pitcairn' )) ),
        ( 'Pacific/Pohnpei', unicode(_( 'Pacific' )) + u'/' + unicode(_( 'Pohnpei' )) ),
        ( 'Pacific/Port_Moresby', unicode(_( 'Pacific' )) + u'/' + unicode(_( 'Port Moresby' )) ),
...
class Event( models.Model ): # {{{1 pylint: disable-msg=R0904
    ...
    def icalendar( self, ical = None ): #{{{3
        ...
        # ORGANIZER should be specified for a valid ical, but we don't know
        # which value to use, so we assign an empty strings, which validates.
        # TODO: Add a meaningful value
        vevent.add('ORGANIZER').value = ''
        if self.starttime:
            ...
            if self.timezone:
                try:
                    ...
                    # backward compatibility as we stored timezones with spaces
                    # in the past
        ...
        DTSTAMP = pytz.timezone(settings.TIME_ZONE).localize(
