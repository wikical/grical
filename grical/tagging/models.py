...
class TaggedItemManager(models.Manager):
    ...
    def get_by_natural_key( self, tag, content_type, obj ):
        tag = Tag.objects.get_by_natural_key( *tag )
        content_type = ContentType.objects.get_by_natural_key( *content_type )
        object_id = \
                content_type.model_class().objects.get_by_natural_key(*obj).id
        return self.get(
...
class TaggedItem(models.Model):
    ...
    def natural_key(self):
        obj = self.content_type.model_class().objects.get(
                id = self.object_id )
        return ( self.tag.natural_key(), self.content_type.natural_key(),
                obj.natural_key() )
